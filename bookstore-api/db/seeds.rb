pub1 = Publisher.create(name: "ABC Publisher", price: 40)
pub2 = Publisher.create(name: "Acme Publishing House", price: 50)
pub3 = Publisher.create(name: "Foobar Corporation", price: 55)
...
booka = Book.create(title: "Something for Later", author: author1, publisher: pub2, price: 9.54)
bookb = Book.create(title: "What If", author: author3, publisher: pub1, price: 13.32)
bookc = Book.create(title: "Lilly Reborn", author: author4, publisher: pub3, price: 16.43)
bookd = Book.create(title: "Anathema", author: author5, publisher: pub3, price: 9.41)
